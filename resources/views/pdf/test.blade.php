                ...
                <div id="recepcion" style="padding:10px">
                        ...
                        <table style="font-size:12;vertical-align:top;width:400px;padding:0px">
                            ...
                            <tr>
                                    ...
                                    <td>
                                    <B>Contacto:</B> <P>{!!$motor->infoMotor->contacto!!}</P> 
                                    </td>
                            </tr>
                            <tr>
                                    <td> <B>Telefono Contacto:</B> <P>{!!$motor->infoMotor->telefono!!}</P>
                                    </td>
                                    <td>
                                    <B>Email Contacto:</B> <P>{!!$motor->infoMotor->email!!}</P> 
                                    </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                    <td> <B>Facturar A:</B> <P>{!!$motor->cliente->infoCliente->razon_social!!}</P>
                                    </td>
                                    <td>
                                    <B>Nit:</B> <P>{!!$motor->cliente->infoCliente->nit!!}</P> 
                                    </td>
                            </tr>
                            <tr>
                                    <td colspan="2"> <B>Direccion Fiscal:</B> <P>{!!$motor->cliente->infoCliente->direccion_fiscal!!}</P>
                                    </td>
